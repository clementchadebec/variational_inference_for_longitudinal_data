...
class AutoConfig(BaseConfig):
    ...
    def from_json_file(cls, json_path):
        ...
        elif config_name == "LVAE_IAF_Config":
            from ..lvae_iaf import LVAE_IAF_Config

            model_config = LVAE_IAF_Config.from_json_file(json_path)

        elif config_name == "LIWAE_IAF_Config":
            from ..liwae_iaf import LIWAE_IAF_Config

            model_config = LIWAE_IAF_Config.from_json_file(json_path)

        elif config_name == "GPVAEConfig":
            from ..gp_vae import GPVAEConfig

            model_config = GPVAEConfig.from_json_file(json_path)
