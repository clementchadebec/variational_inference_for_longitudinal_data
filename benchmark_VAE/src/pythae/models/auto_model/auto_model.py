...
class AutoModel(nn.Module):
    ...
    def load_from_folder(cls, dir_path: str):
        ...
        elif model_name == "LVAE_IAF_Config":
            from ..lvae_iaf import LVAE_IAF

            model = LVAE_IAF.load_from_folder(dir_path=dir_path)

        elif model_name == "LIWAE_IAF_Config":
            from ..liwae_iaf import LIWAE_IAF

            model = LIWAE_IAF.load_from_folder(dir_path=dir_path)

        elif model_name == "GPVAEConfig":
            from ..gp_vae import GPVAE

            model = GPVAE.load_from_folder(dir_path=dir_path)
