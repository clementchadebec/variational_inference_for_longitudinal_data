...
def main(args):
    ...
    if args.dataset == "colormnist":
        test_data = torch.load(os.path.join('/gpfswork/rech/wlr/uhw48em/rvae/benchmark_VAE/examples/data/colormnist/test_12_long_color_mnist.pt'), map_location="cpu")
    ...
    elif model.model_name == "VAE" or model.model_name == "IWAE":
